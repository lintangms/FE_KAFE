    ...
    <div class="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
      <div class="max-w-xl mb-6">
        <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-blue-900 sm:text-4xl sm:leading-none">
          Welcome to SCOFF caffee<br class="hidden md:block" />
          Your Serene Haven for Business and Leisure
        </h2>
        <p class="text-base text-gray-700 md:text-lg">
        Welcome to Wikusama cafe, where luxury meets tranquility. Nestled in a picturesque location, our hotel offers a serene and enchanting ambiance, making it the perfect destination for both leisure and business travelers.
        </p>
      </div>
      <div>
      </div>
